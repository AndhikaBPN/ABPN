...
//        AFTER
        ...
        System.out.println(aft.substring(0,aft.length()-1) + " -> INI ADALAH HASIL DARI Selection Sort ASC");
...
//        AFTER
        ...
        System.out.println(aft.substring(0,aft.length()-1) + " -> INI ADALAH HASIL DARI Bubble Sort ASC");
